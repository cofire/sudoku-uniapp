...
/***/ 15:
/*!*********************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/Json.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var transactionList = [{
  petrolName: "澄阳湖服务区中石油加油站 ",
  companyName: "八骏物流车队 ",
  modeName: "0#",
  createTime: "04-17 14:43",
  money: 300 },
{
  petrolName: "澄阳湖服务区中石油加油站 ",
  companyName: "八骏物流车队 ",
...

{
  ...
  petrolList: petrolList,
  transactionList: transactionList,
  chanelList: chanelList,
  orderTypeList: orderTypeList };exports.default = _default;

/***/ }),

/***/ 16:
/*!********************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/config/Base_api.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var API_BASE_URL = "http://192.168.100.117:8093/tanker-api";
...
var _default = {
  ...
  //加油交易
  addTransaction: API_BASE_URL + "/app/driver/transaction" };exports.default = _default;

/***/ }),

/***/ 17:
/*!**********************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/config/MinRequest.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
MinRequest = /*#__PURE__*/function () {function MinRequest() {_classCallCheck(this, MinRequest);_defineProperty(this,
...

    {
      ...
      } });}_createClass(MinRequest, [{ key: "setConfig",
    ...
    options) {
      ...
      options.header = _objectSpread({}, this[config].header, {},
      options.header);
    ...
    url, data, options) {
      ...
      options.method = 'POST';
      return this.request(options);
    } }], [{ key: requestBefore, value: function value(config) {return config;} }, { key: requestAfter, value: function value(response) {return response;} //判断URL是否完整
  }, { key: isCompleteURL, value: function value(url) {return /(http|https):\/\/([\w.]+\/?)\S*/.test(url);} }]);return MinRequest;}();
...
/***/ 18:
/*!***************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/config/api.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _MinRequest = _interopRequireDefault(__webpack_require__(/*! ./MinRequest */ 17));
...
var _Common = _interopRequireDefault(__webpack_require__(/*! ../pages/Common.vue */ 19));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var minRequest = new _MinRequest.default(); // 请求拦截器
minRequest.interceptors.request(function (request) {// let refreshToken = Vue.prototype.$cache.get(common.RERRESH_TOKEN);
  ...
  // 	});
  // }
  return request;}); // 响应拦截器
minRequest.interceptors.response(function (response) {var result = response.data; //未登录，无权限
  if (!result.success && result.code == 401) {_vue.default.prototype.$openPage('Auth');return response.data;} //参数校验失败
  if (!result.success && result.code == 400) {_vue.default.prototype.$msg("参数校验失败,请检查{}" + response.data.msg, 3000);return response.data;}return response.data;}); // 设置默认配置
minRequest.setConfig(function (config) {return config;});var _default = { // 这里统一管理api请求
  apis: { uniapp_get: function uniapp_get(url, data) {var header = { header: { 'token': _vue.default.prototype.$cache.get(_Common.default.AUTHORIZATION) } };return minRequest.get(url, data, header);}, uniapp_post: function uniapp_post(url, data, type, token) {var header = { header: { 'content-type': 'application/json', 'token': _vue.default.prototype.$cache.get(_Common.default.AUTHORIZATION) } };var options = { header: { 'token': _vue.default.prototype.$cache.get(_Common.default.AUTHORIZATION) } };if (type == 'json') {return minRequest.post(url, data, header);}return minRequest.post(url, data, options);} } };exports.default = _default;
...
/***/ 22:
/*!***************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/config/md5.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 23:
/*!********************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/config/MinCache.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
MinCache = /*#__PURE__*/function () {
  ...
  //设置缓存信息
  _createClass(MinCache, [{ key: "set", value: function set(name, data) {var timeout = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : timeoutDefault;
    ...
    //删除缓存
  }, { key: "delete", value: function _delete(name) {
      var value = false;
      if (name.startsWith('_')) {
        try {
          uni.removeStorageSync(name);
...
/***/ 24:
/*!*********************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/config/MinRouter.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function openPage(args) {
  ...
  switch (true) {
    case isObject(args):
      ...
      args.name;var _args$query = args.query;query = _args$query === void 0 ? {} : _args$query;
      break;
    case isString(args):
      name = args;
      break;
...
/***/ 25:
/*!*********************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/config/BaseUtils.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  install: function install(Vue) {
    /**
                                   ...
                                   * 方法可根据实际情况扩展
                                   */
    Vue.prototype.formatDate = function (timeString) {//全局函数1
      var year = '';
      var month = '';
      var day = '';
      var hour = '';
    ...
    /**
        ...
        */
    Vue.prototype.formatTableTime = function (row, column) {
    ...
    /**
        ...
        */
    Vue.prototype.getQueryTimeBeginAndEnd = function (queryTimeList) {
    ...
    /**
        ...
        */
    Vue.prototype.getWeekStartAndEndTimeDate = function (beginTime, endTime) {
      var beginTimeString = Vue.prototype.formatDate(beginTime);
      var endTimeString = Vue.prototype.formatDate(endTime);
      var BeginDate = new Date(Date.parse(beginTimeString.replace(/-/g, "/")));
      var EndDate = new Date(Date.parse(endTimeString.replace(/-/g, "/")));
    ...
    /**
        * 获取本周的开始和结束时间对象
        */
    Vue.prototype.getCurrentWeekStartAndEndTimeDate = function () {
      var now = new Date();
      ...
      var beginDate = new Date(MondayTime);
      ...
      var beginTimeString = beginYear + '-' + beginMonth + '-' + beginDay + ' ' + "00:00:00";
      ...
      var endTimeString = endYear + '-' + endMonth + '-' + endDay + ' ' + '23:59:59';
      var BeginDate = new Date(Date.parse(beginTimeString.replace(/-/g, "/")));
      var EndDate = new Date(Date.parse(endTimeString.replace(/-/g, "/")));
      return [BeginDate, EndDate];
    };
    ...
    /**
        ...
        */
    Vue.prototype.getCurrentDayStartAndEndTime = function (formate) {
      var date = new Date();
    ...
    /**
        ...
        */
    Vue.prototype.dateConvertStartTimeString = function (date) {
      var year = date.getFullYear();
      var month = date.getMonth() + 1;
      var day = date.getDate();
      if (month >= 1 && month <= 9) {
    ...
    /**
        ...
        */
    Vue.prototype.dateConvertEndTimeString = function (date) {
      var year = date.getFullYear();
      var month = date.getMonth() + 1;
      var day = date.getDate();
      if (month >= 1 && month <= 9) {
    ...
    /** js对象深度复制 */
    Vue.prototype.copyObject = function (source, dest) {
    ...
    /** 格式化字符串  */
    Vue.prototype.formatStr = function (value, args) {
      var arr = args.split(",");
      var count = 0;
    ...
    Vue.prototype.isFalse = function (value) {
...
/***/ 26:
/*!***********************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/router.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _MinRouter = _interopRequireDefault(__webpack_require__(/*! ./config/MinRouter */ 24));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var router = new _MinRouter.default({
  ...
  {
    path: 'pages/driver/barCode/barCode',
    type: 'navigateTo',
    name: 'barCode' },

  {
    path: 'pages/driver/petrol/petrolList',
    type: 'switchTab',
    name: 'petrolList' },

  {
    path: 'pages/driver/transaction/transactionlist',
    type: 'navigateTo',
    name: 'transactionlist' },

  {
    path: 'pages/driver/order/order',
    type: 'navigateTo',
    name: 'order' },

  {
    path: "pages/driver/order/orderPaySuccess",
    type: 'navigateTo',
    name: 'orderPaySuccess' }] });var _default =
...
/***/ 4:
/*!************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!*****************************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/pages.json?{"type":"style"} ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/login/login": { "navigationBarTitleText": "登录", "navigationStyle": "custom", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/driver/user/user": { "navigationBarTitleText": "我的", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/driver/order/orderPaySuccess": { "navigationBarTitleText": "下单成功", "navigationStyle": "custom", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/driver/order/order": { "navigationBarTitleText": "下单", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/driver/petrol/petrolList": { "navigationBarTitleText": "加油站列表", "enablePullDownRefresh": true, "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/driver/transaction/transactionlist": { "navigationBarTitleText": "加油明细", "enablePullDownRefresh": true, "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/driver/barCode/barCode": { "navigationBarTitleText": "加油码", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/driver/index/index": { "navigationBarTitleText": "首页", "usingComponents": {}, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "车享", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!****************************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/pages.json?{"type":"stat"} ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__B5A3B05" };exports.default = _default;

/***/ }),

/***/ 81:
/*!********************************************************!*\
  !*** D:/work/2020/cx/tanker-uniapp/config/wxqrcode.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
